                          ...
                          <div class="col-md-12">
                              <div class="panel panel-default">
                                  <div class="panel-heading">
                                    Manage Data
                                    <a href="tambah_data.php"><button class="btn btn-primary" style="margin-left: 82%">Tambah</button></a>
                                  </div>
                                  <div class="panel-body">
                                      <div  style="width: 100%; height: 600px; position: relative;">

                                        <table class="table table-striped table-bordered" id="datatable" style="max-width: 100%;">
                                          <thead>
                                            <tr>
                                              <th>Lat</th>
                                              <th>Lon</th>
    ...
    while ($row=mysqli_fetch_assoc($hasil)){
      ...
      <tr>
        ...
        <td style="width: 16%">
          ...
          <a href="delete.php?id=<?php echo $row['id'] ?>" title=""><button class="btn btn-danger">Hapus</button></a>
        </td>
      </tr>
      <?php
    }
