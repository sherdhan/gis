...
?>
  ...
  <head>
    ...
    <title>GIS Pemetaan Longsor</title>   
    ...
    <script>
      ...
      function initialize() 
      {
        ...
        $kon= mysqli_connect("localhost","root","");
            ...
            $query = mysqli_query($kon,"SELECT * FROM data_location");
            while ($data = mysqli_fetch_array($query))
            {
                ...
                echo ("addMarker($lat, $lon, '<b><a href=\"page/desk_lok.php?des=$nama\">$nama</a></b>');\n");                        
            }
          ?>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              ...
              <h3>General</h3>
                <ul class="nav side-menu">
                  <li>
                    <a href="index.php"><i class="fa fa-home"></i>Home<span></span></a>   
                  </li>
                  <!-- <li>
                    <a><i class="fa fa-edit"></i>Manage Data<span class="fa fa-chevron-down"></span></a>
                      ...
                      <div class="row">
                          <div class="col-md-12">
                              <div class="panel panel-default">
                                  <div class="panel-heading">Peta UIN Maliki Kampus</div>
                                  <div class="panel-body">
                                      <div id="map-canvas" style="width: 100%; height: 600px; position: relative;"></div>
                                  </div>
                              </div>
